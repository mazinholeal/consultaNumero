 ...
 * Se SQLite não estiver disponível, usa versão fallback automaticamente
 */
...
if (!extension_loaded('pdo_sqlite')) {
    ...
    // SQLite disponível - usar versão com banco de dados
    class ConsultaDatabase {
        ...
        public function updateConsulta($jobId, $data) {
            ...
            if (isset($data['status']) && ($data['status'] === 'completed' || $data['status'] === 'error')) {
